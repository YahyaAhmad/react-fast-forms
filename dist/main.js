...
Object.defineProperty(exports, "__esModule", { value: true });
var builder_1 = __webpack_require__(/*! ./builder */ "./src/builder/index.ts");
var FieldManager_1 = __importDefault(__webpack_require__(/*! ./elements/FieldManager */ "./src/elements/FieldManager.tsx"));
var React = __importStar(__webpack_require__(/*! react */ "react"));
var prop_types_1 = __importDefault(__webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js"));
var ContainerManager_1 = __importDefault(__webpack_require__(/*! ./elements/ContainerManager */ "./src/elements/ContainerManager.tsx"));
...
var Form = function (props) {
    ...
    var recursiveRender = function (elements) {
        var renderElements;
        elements.forEach(function (element) {
            if (element instanceof builder_1.Container) {
                var ContainerComponent = element.getComponent();
                var children = recursiveRender(element.getFields());
                renderElements = (React.createElement(React.Fragment, null,
                    renderElements,
                    React.createElement(ContainerManager_1.default, { render: children, containerProps: element.getProps(), label: element.getLabel() },
...
var Field = /** @class */ (function () {
    function Field() {
        ...
        this.validate = function (value) {
            _this.setError(null);
            _this.validator(value, _this.setError);
            if (_this.getError()) {
                return false;
            }
            else {
        ...
        this.getError = function () { return _this.errorMessage; };
        this.getComponent = function () { return _this.component; };
        ...
        this.isRequired = function () { return _this.required; };
        this.setRendered = function (rendered) {
            if (rendered === void 0) { rendered = true; }
            _this.rendered = rendered;
            return _this;
        };
...
var Container = /** @class */ (function () {
    function Container() {
        ...
        this.type = "container";
        this.props = {};
        this.getLabel = function () { return _this.name; };
        this.setLabel = function (label) {
            _this.label = label;
            return _this;
        };
...
function createContainer(component, name) {
    if (component === void 0) { component = GenericContainer_1.default; }
...
function createField(component, name) {
    ...
    if (typeof component === "string") {
        ...
        component = GenericField_1.default;
    }
...
/***/ "./src/elements/ContainerManager.tsx":
/*!*******************************************!*\
  !*** ./src/elements/ContainerManager.tsx ***!
  \*******************************************/
/*! no static exports found */
...
exports.ContainerContext = react_1.default.createContext(null);
var ContainerManager = function (_a) {
    var children = _a.children, containerProps = _a.containerProps, render = _a.render;
    return (react_1.default.createElement(exports.ContainerContext.Provider, { value: { render: render, containerProps: containerProps } }, children));
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __importStar(__webpack_require__(/*! react */ "react"));
exports.FieldContext = React.createContext(null);
var FieldManager = function (_a) {
    var field = _a.field, error = _a.error;
    var fieldProps = field.getProps();
    var label = field.getLabel();
    var FieldComponent = field.getComponent();
    var name = field.getName();
    var classNames = ["field-container", "field-" + name];
    return (React.createElement(exports.FieldContext.Provider, { value: { fieldProps: fieldProps, name: name } },
        React.createElement("div", { className: classNames.join(" ") },
            ...
            React.createElement(FieldComponent, null))));
};
...
/***/ "./src/elements/GenericContainer.tsx":
/*!*******************************************!*\
  !*** ./src/elements/GenericContainer.tsx ***!
  \*******************************************/
/*! no static exports found */
...
var GenericContainer = function () {
    var _a = hooks_1.useContainer({ tag: "div" }), render = _a[0], tag = _a[1].tag;
    var Tag = tag;
    return (react_1.default.createElement(Tag, { "data-type": "container" }, render));
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var Form_1 = __webpack_require__(/*! ./Form */ "./src/Form.tsx");
var FieldManager_1 = __webpack_require__(/*! ./elements/FieldManager */ "./src/elements/FieldManager.tsx");
var react_1 = __webpack_require__(/*! react */ "react");
var ContainerManager_1 = __webpack_require__(/*! ./elements/ContainerManager */ "./src/elements/ContainerManager.tsx");
var lodash_1 = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/**
 *
 ...
 * @returns An array
 */
exports.useContainer = function (defaultValues) {
    if (defaultValues === void 0) { defaultValues = {}; }
    var _a = react_1.useContext(ContainerManager_1.ContainerContext), render = _a.render, containerProps = _a.containerProps;
    var newProps = lodash_1.merge(defaultValues, containerProps);
...
var builder_1 = __webpack_require__(/*! ./builder */ "./src/builder/index.ts");
exports.createContainer = builder_1.createContainer;
exports.createField = builder_1.createField;
var hooks_1 = __webpack_require__(/*! ./hooks */ "./src/hooks.ts");
exports.useField = hooks_1.useField;
exports.useContainer = hooks_1.useContainer;
